...
class RegistrationForm
{
    ...
    {
        $args = [
            'username' => ['filter' => FILTER_VALIDATE_REGEXP, 'options' => ['regexp' => '/^[A-Za-z0-9_]{3,25}$/']],
            'fullName' => ['filter' => FILTER_VALIDATE_REGEXP, 'options' => ['regexp' => '/^[A-Z][a-ząęłńśćźżó]{1,25}\s[A-Z][a-ząęłńśćźżó]{1,25}$/']],
